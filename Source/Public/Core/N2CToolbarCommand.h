...
public:
    ...
    TSharedPtr<FUICommandInfo> CopyEntireBlueprintJsonCommand;
    ...
    static const FName CommandName_CopyEntireBlueprintJson;
    ...
    static const FText CommandLabel_CopyEntireBlueprintJson;
    ...
    static const FText CommandTooltip_CopyEntireBlueprintJson;
